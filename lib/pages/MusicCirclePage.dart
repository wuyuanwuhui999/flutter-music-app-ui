...
class _MusicCirclePageState extends State<MusicCirclePage>
  ...
  onTapMenu(CircleModel mCircleModel) {
    ...
    circleOverlayEntry = OverlayEntry(builder: (context) {
      // RenderObject? renderBox = circleModel.key.currentContext.findRenderObject() as RenderBox;;
      //获取当前屏幕位置
      ...
      return Positioned(
          ...
          child: GestureDetector(
            ...
            child: Stack(
              children: [
                Positioned(
                    top: 0,// offset.dy - ThemeSize.smallIcon / 2,
                    left: 0,
  ...
  void buildCommentInputDailog() {
    ...
    inputOverlayEntry = OverlayEntry(builder: (BuildContext context) {
      return Positioned(
        bottom: 0,
        left: 0,
        right: 0,
...
;                        }else{
            ...
            Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height: circleModel.circleLikes!.isNotEmpty
  ...
  Widget buildCircleLikeAndCommentList(CircleModel circleModel) {
    ...
    if (circleLikes.isNotEmpty || circleComments.isNotEmpty) {
      return Container(
          padding: ThemeStyle.padding,
          decoration: BoxDecoration(
              color: ThemeColors.colorBg,
  ...
  List<Widget> buildCircleCommentItems(
    ...
    for (var circleComment in circleComments) {
      circleCommentWidget
          .add(Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ClipOval(
            child: circleComment.avater != null ? Image.network(
              //从全局的provider中获取用户信息
