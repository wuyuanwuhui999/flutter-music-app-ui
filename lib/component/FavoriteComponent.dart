...
class FavoriteComponent extends StatefulWidget {
  ...
  FavoriteComponent({super.key, required this.musicId,required this.isFavorite, required this.onFavorite});
              ...
              Row(
                children: [
                  ...
                  Checkbox(
                      ...
                      onChanged: (value) {
                        setState(() {
                          item.checked = value != null ? 1 : 0;
                          selectedValues.clear();
                          for (var item in favoriteDirectory) {
                            if (item.checked == 1) {
