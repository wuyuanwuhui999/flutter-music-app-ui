...
class MusicModel extends ClassMusicParamsModel{
  ...
  MusicModel(
      ...
      this.finalId, // 未使用字段
        required this.audioId, // 音频id
      this.similarAudioId, // 未使用字段
      this.isHot, // 是否热门
        required this.albumAudioId, // 音频专辑id
      ...
      this.lyrics, // 歌词
        ...
        required this.times,
        required super.classifyId,
        required super.pageNum,
        required super.pageSize,
        super.isRedis // 听过的次数，在获取播放记录的时候才有
      });
  ...
  factory MusicModel.fromJson(dynamic json) {
    return MusicModel(
        ...
        lyrics: json["lyrics"],
        isLike: json["isLike"],
        times: json["times"], classifyId: null, pageNum: null, pageSize: null);
  }
